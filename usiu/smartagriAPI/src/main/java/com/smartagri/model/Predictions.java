...
public class Predictions implements Serializable {
    ...
    public Predictions county(String county) {
        this.county = county;
        return this;
    }
    ...
    public Predictions commodity(String commodity) {
    ...
    public Predictions year(String year) {
        this.year = year;
        return this;
    }
    ...
    public Predictions month(String month) {
        this.month = month;
        return this;
    }
    ...
    public Predictions season(String season) {
        this.season = season;
        return this;
    }
    ...
    public Predictions quantities(String quantities) {
    ...
    public Predictions sellingprice(String selling_price) {
    ...
    public Predictions householdsizes(String household_sizes) {
    ...
    public Predictions totaldemandinkes(String total_demand_in_kes) {
    ...
    public Predictions totalhouseholddemandkg(String total_household_demand_kg) {
    ...
    public Predictions annualavginflation(String annual_avg_inflation) {
    ...
    public Predictions twelvemonthinflation(String twelve_month_inflation) {
    ...
    public Predictions nafisdate(String nafis_date) {
    ...
    public Predictions nafisunitsfiftykg(String nafis_units_fifty_kg) {
    ...
    public Predictions nafisprices(String nafis_prices) {
    ...
    public Predictions predictions(String predictions) {
    ...
    public Predictions predictiondate(String prediction_date) {
    ...
    public Predictions avgtemp(String avg_temp) {
    ...
    public Predictions maxtemp(String max_temp) {
    ...
    public Predictions mintemp(String min_temp) {
    ...
    public Predictions precipitationmm(String precipitation_mm) {
    ...
    public Predictions avghumidity(String avg_humidity) {
    ...
    public Predictions maxhumidity(String max_humidity) {
    ...
    public Predictions minhumidity(String min_humidity) {
    ...
    public Predictions monthval(String month_val) {
    ...
    public Predictions seasonval(String season_val) {
    ...
    public Predictions active(Integer active) {
        this.active = active;
        return this;
    }
    ...
    public Predictions insertedby(Integer insertedby) {
    ...
    public Predictions datecreated(Instant datecreated) {
    ...
    public Predictions updatedby(Integer updatedby) {
    ...
    public Predictions datemodified(LocalDate datemodified) {
    ...
    public boolean equals(Object o) {
        ...
        Predictions prediction = (Predictions) o;
