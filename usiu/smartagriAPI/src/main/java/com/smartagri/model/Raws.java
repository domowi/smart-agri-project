...
/**
 * Model for table Raws.
 */
@Entity
@Table(name = "raws")
public class Raws implements Serializable {
    ...
    public Raws county(String county) {
        this.county = county;
        return this;
    }
    ...
    public Raws commodity(String commodity) {
    ...
    public Raws month(String month) {
        this.month = month;
        return this;
    }
    ...
    public Raws season(String season) {
        this.season = season;
        return this;
    }
    ...
    public Raws quantities(String quantities) {
    ...
    public Raws sellingprice(String selling_price) {
    ...
    public Raws householdsizes(String household_sizes) {
    ...
    public Raws totaldemandinkes(String total_demand_in_kes) {
    ...
    public Raws totalhouseholddemandkg(String total_household_demand_kg) {
    ...
    public Raws annualavginflation(String annual_avg_inflation) {
    ...
    public Raws twelvemonthinflation(String twelve_month_inflation) {
    ...
    public Raws nafisdate(String nafis_date) {
    ...
    public Raws nafisunitsfiftykg(String nafis_units_fifty_kg) {
    ...
    public Raws nafisprices(String nafis_prices) {
    ...
    public Raws avgtemp(String avg_temp) {
    ...
    public Raws maxtemp(String max_temp) {
    ...
    public Raws mintemp(String min_temp) {
    ...
    public Raws precipitationmm(String precipitation_mm) {
    ...
    public Raws avghumidity(String avg_humidity) {
    ...
    public Raws maxhumidity(String max_humidity) {
    ...
    public Raws minhumidity(String min_humidity) {
    ...
    public Raws monthval(String month_val) {
    ...
    public Raws seasonval(String season_val) {
    ...
    public Raws active(Integer active) {
        this.active = active;
        return this;
    }
    ...
    public Raws insertedby(Integer insertedby) {
    ...
    public Raws datecreated(Instant datecreated) {
    ...
    public Raws updatedby(Integer updatedby) {
    ...
    public Raws datemodified(LocalDate datemodified) {
    ...
    public boolean equals(Object o) {
        ...
        Raws raw = (Raws) o;
        if (raw.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), raw.getId());
    }
