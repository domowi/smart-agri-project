 ...
 */
public class SimpleExcelReaderExample2 {

    public static void main(String[] args) throws IOException {

        SimpleExcelReaderExample2 simpleExcelReaderExample = new SimpleExcelReaderExample2();
                    ...
                    if (cell.getCellType() == Cell.CELL_TYPE_BLANK) {
                        ...
                        if ((columnIndex > 3) && (columnIndex < avgColumnIndex)) {
                            ...
                            if (columnIndex == (avgColumnIndex - 1)) {
                                ...
                                System.out.print("CELL_TYPE_BLANK >>>>>> RowNum: " + rowNum + " :>>>>>> columnIndex.......: " + columnIndex + " >>>>> " + cumulativeMap.get("AVG") + " ::: \n");

                                //cumulativeMap = new HashMap<>();

                                //avgAmount = Math.round(sumAmount / avgCount);
                                //System.out.print(">>>>>> RowNum: " + rowNum + ">>>>>> columnIndex.......: " + columnIndex + " :: average " + avgAmount + " :: sumAmount " + sumAmount + " :: avgCount " + avgCount + "\n\n");
                                cumulativeMap.put("AVG", cumulativeMap.get("AVG"));
                                ...
                                cumulativeMap.put("MAX", cumulativeMap.get("MAX"));
                                cumulativeMap.put("MIN", cumulativeMap.get("MAX"));
