 ...
 */
public class SimpleExcelReaderExample4 {

    public static void main(String[] args) throws IOException {

        SimpleExcelReaderExample4 simpleExcelReaderExample = new SimpleExcelReaderExample4();
...
//        map.put("OTHERS", cerealsList);
        ...
        String excelFilePath = "27-3-2018.xls";
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                List<String> finalMinMaxValList = new ArrayList<>();
                ...
                while (cellIterator.hasNext()) {
                    ...
                    Map<String, Double> cumulativeMap = null;
...
//                                metricListMap.put(rowNum, cumulativeMap);
                                ...
                                if(minMaxValList.isEmpty()){
                                    ...
                                    System.out.print("CELL_TYPE_NUMERIC >>>>>> RowNum: " + rowNum + " :>>>>>> minMaxValList 555555555555555555 .......: " + minMaxValList.toString() + " ::: \n");

                                    // sort the list and extract the minimum and maximum values
                                    sortedList = minMaxValList.stream().sorted(Comparator.naturalOrder()).collect(Collectors.toList());
                                    System.out.print("CELL_TYPE_NUMERIC >>>>>> RowNum: " + rowNum + " :>>>>>> sortedList 666666666666666666 .......: " + minMaxValList.toString() + " ::: \n");
...
//                                metricListMap.put(rowNum, cumulativeMap);
                                ...
                                if(minMaxValList.isEmpty()){
                                    ...
                                    System.out.print("CELL_TYPE_BLANK >>>>>> RowNum: " + rowNum + " :>>>>>> minMaxValList 555555555555555555 .......: " + minMaxValList.toString() + " ::: \n");

                                    // sort the list and extract the minimum and maximum values
                                    sortedList = minMaxValList.stream().sorted(Comparator.naturalOrder()).collect(Collectors.toList());
                                    System.out.print("CELL_TYPE_BLANK >>>>>> RowNum: " + rowNum + " :>>>>>> sortedList 666666666666666666 .......: " + minMaxValList.toString() + " ::: \n");
...
//                            continue;
//                        } else {
//                            System.out.print("CELL_TYPE_ALL >>>>>> RowNum: " + rowNum + " :>>>>>> minMaxValList 555555555555555555 .......: " + minMaxValList.toString() + " ::: \n");
//
//                            // sort the list and extract the minimum and maximum values
//                            sortedList = minMaxValList.stream().sorted(Comparator.naturalOrder()).collect(Collectors.toList());
//                            System.out.print("CELL_TYPE_ALL >>>>>> RowNum: " + rowNum + " :>>>>>> minMaxValList 666666666666666666 .......: " + minMaxValList.toString() + " ::: \n");
//
//                            maxVal = Double.valueOf(sortedList.get(sortedList.size() - 1));
//                            minVal = Double.valueOf(sortedList.get(0));
//                            //System.out.println("\n minVal = " + minVal + " :: maxVal = " + maxVal);
...
//                        System.out.print("CELL_TYPE_ALL >>>>>> RowNum: " + rowNum + " :>>>>>> minMaxValList 3333333 .......: " + minMaxValList.toString() + " ::: \n");
//                        finalMinMaxValList = minMaxValList;
//
////                        // sort the list and extract the minimum and maximum values
////                        finalMinMaxValList = minMaxValList.stream().sorted(Comparator.naturalOrder()).collect(Collectors.toList());
////                        maxVal = Double.valueOf(finalMinMaxValList.get(finalMinMaxValList.size() - 1));
////                        minVal = Double.valueOf(finalMinMaxValList.get(0));
////                        //System.out.println("\n minVal = " + minVal + " :: maxVal = " + maxVal);
//                        System.out.print("CELL_TYPE_ALL >>>>>>+++++++++++++++ RowNum: " + rowNum + " :>>>>>> 44444444444444444 Metrics .......: " + convertWithStream(metricListMap) + " ::: \n");
//
////                        cumulativeMap.put("MAX", maxVal);
////                        cumulativeMap.put("MIN", minVal);
////                        metricListMap.put(rowNum, cumulativeMap);
